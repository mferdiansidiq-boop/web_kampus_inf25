    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('admin/Prodi') ?>" class="btn btn-flat btn-secondary btn-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/prodi/update/' . $prodi['id_prodi']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= !empty($validationErrors['nama_prodi']) ? 'is-invalid' : '' ?>" 
                           ...
                           value="<?= !empty($oldInput['nama_prodi']) ? $oldInput['nama_prodi'] : $prodi['nama_prodi'] ?>" required>
