<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('admin/slider/update/' . $slider['id_slider']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= !empty($validationErrors['judul_slider']) ? 'is-invalid' : '' ?>" 
                           ...
                           value="<?= !empty($oldInput['judul_slider']) ? $oldInput['judul_slider'] : $slider['judul_slider'] ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control <?= !empty($validationErrors['url_terkait']) ? 'is-invalid' : '' ?>" 
                           ...
                           value="<?= !empty($oldInput['url_terkait']) ? $oldInput['url_terkait'] : $slider['url_terkait'] ?>" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="gambar_slider">Pilih file (Kosongkan jika tidak ingin mengubah)</label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <img src="<?= base_url('uploads/slider/' . $slider['gambar_slider']) ?>" alt="Gambar Slider" style="max-width: 100%; max-height: 300px; border: 1px solid #ddd; padding: 5px;">
                    </div>
                </div>
